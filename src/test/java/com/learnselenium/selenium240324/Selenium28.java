...
//        List<WebElement> row_element = table.findElements(By.tagName("tr"));
//        System.out.println(row_element.size());
//
//        for(int i=0; i < rows_table.size(); i++)
//        {
//            List<WebElement> col = row_element.get(i).findElements(By.tagName("td"));
//
